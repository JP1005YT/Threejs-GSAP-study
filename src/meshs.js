...
export function MeshLoader() {
  function TextureLoader() {
    return {
      granite: new THREE.TextureLoader().load(
        "models/textures/granite.jpg",
        function (texture) {
      ...
      piso: new THREE.TextureLoader().load(
        "models/textures/piso.jpg",
        function (texture) {
          texture.wrapS = THREE.RepeatWrapping;
          texture.wrapT = THREE.RepeatWrapping;
      ...
      fire: new THREE.TextureLoader().load("./../models/textures/fire.png"),
    };
  }
